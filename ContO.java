...
public class ContO {
   ...
   public void d(Graphics var1) {
      ...
      if(!this.out && var2 != this.npl) {
         ...
         var3 = this.m.cx + (int)((float)(this.x - this.m.x - this.m.cx) * this.m.cs.getcos(this.m.xz) - (float)(this.z - this.m.z - this.m.cz) * this.m.cs.getsin(this.m.xz));
         ...
         if(this.xs(var3 + this.maxR, var5) > 0 && this.xs(var3 - this.maxR, var5) < this.m.w && var5 > -this.maxR && var5 < '\uc350' && this.xs(var3 + this.maxR, var5) - this.xs(var3 - this.maxR, var5) > this.disp || this.exp) {
            int var6;
            int var8;
            if(this.shadow || this.exp) {
               var6 = this.m.cy + (int)((float)(this.m.ground - this.m.cy) * this.m.cs.getcos(this.m.zy) - (float)(var4 - this.m.cz) * this.m.cs.getsin(this.m.zy));
               ...
               if(this.ys(var6 + this.maxR, var7) > 0 && this.ys(var6 - this.maxR, var7) < this.m.h || this.exp) {
                  for(var8 = 0; var8 < this.npl; ++var8) {
                     this.p[var8].s(var1, this.x - this.m.x, this.y - this.m.y, this.z - this.m.z, this.xz, this.xy, this.zy, this.loom);
                  }
               }
            }

            var6 = this.m.cy + (int)((float)(this.y - this.m.y - this.m.cy) * this.m.cs.getcos(this.m.zy) - (float)(var4 - this.m.cz) * this.m.cs.getsin(this.m.zy));
            if(this.ys(var6 + this.maxR, var5) > 0 && this.ys(var6 - this.maxR, var5) < this.m.h || this.exp) {
               if(this.m.jumping != 0 && this.m.jumping < 4) {
                  this.hit = true;
               }

               int[] var10 = new int[this.npl];

               int var9;
               for(var8 = 0; var8 < this.npl; ++var8) {
                  var10[var8] = 0;

                  for(var9 = 0; var9 < this.npl; ++var9) {
                     if(this.p[var8].av != this.p[var9].av) {
                        if(this.p[var8].av < this.p[var9].av) {
                           ++var10[var8];
                        }
                     } else if(var8 > var9) {
               ...
               for(var8 = 0; var8 < this.npl; ++var8) {
                  for(var9 = 0; var9 < this.npl; ++var9) {
                     if(var10[var9] == var8) {
                        this.p[var9].d(var1, this.x - this.m.x, this.y - this.m.y, this.z - this.m.z, this.xz, this.xy, this.zy, this.hit, this.wire, this.loom);
                     }
                  }
               }
