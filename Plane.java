...
public class Plane {
    ...
    public void loadprojf() {
        ...
        do {
            ...
            do {
                if (j != i) {
                    projf *= (float) (Math.sqrt((ox[i] - ox[j]) * (ox[i] - ox[j]) + (oz[i] - oz[j]) * (oz[i] - oz[j])) / 100.0D);
                }
                ++j;
            } while (j < 3);
            ++i;
    ...
    public Plane(final Medium var1, final int[] var2, final int[] var3, final int[] var4, final int var5, final int[] var6) {
        ...
        do {
            ...
            do {
                if (var8 != var7) {
                    deltaf *= (float) (Math.sqrt((ox[var8] - ox[var7]) * (ox[var8] - ox[var7]) + (oy[var8] - oy[var7]) * (oy[var8] - oy[var7]) + (oz[var8] - oz[var7]) * (oz[var8] - oz[var7])) / 100.0D);
                }
                ++var8;
            } while (var8 < 3);
            ++var7;
    ...
    public void d(final Graphics graphics, final int i, final int j, final int k, final int l, final int i1, final int j1, final boolean flag, final boolean flag2, final boolean flag3) {
        if (exp != 7) {
            ...
            final int[] ints2 = new int[n];
            final int[] ints3 = new int[n];
            int k1;
            for (k1 = 0; k1 < n; ++k1) {
                ints[k1] = ox[k1] + i;
                ints3[k1] = oy[k1] + j;
            ...
            if (exp != 0) {
                ...
                if (sy[3] < m.ground) {
                    ...
                    final int[] ints7 = new int[4];
                    final int[] ints8 = new int[4];
                    boolean flag4 = false;
                    i2 = 0;
                    do {
            ...
            if (i1 != 0 || j1 != 0 || exp != 0 || l != 0) {
                ...
                do {
                    ...
                    do {
                        if (j2 != k1) {
                            projf *= (float) (Math.sqrt((ints[k1] - ints[j2]) * (ints[k1] - ints[j2]) + (ints2[k1] - ints2[j2]) * (ints2[k1] - ints2[j2])) / 100.0D);
                        }
                        ++j2;
                    } while (j2 < 3);
                    ++k1;
            ...
            boolean flag6 = true;
            boolean flag7 = false;
            final int[] ints9 = new int[n];
            final int[] ints10 = new int[n];
            int j3 = 0;
            int k3 = 0;
            int l4 = 0;
            int i4 = 0;
            ...
            av = 0;
            for (k4 = 0; k4 < n; ++k4) {
                av += (int) Math.sqrt((m.cy - ints10[k4]) * (m.cy - ints10[k4]) + (m.cx - ints9[k4]) * (m.cx - ints9[k4]) + ints2[k4] * ints2[k4]);
            }
            av /= n;
        }
    }
    ...
    public void rot(final int[] ints, final int[] ints2, final int i, final int j, final int k, final int l) {
        if (k != 0) {
            for (int i1 = 0; i1 < l; ++i1) {
                final int j1 = ints[i1];
                final int k1 = ints2[i1];
                ints[i1] = i + (int) ((j1 - i) * SinCos.cos(k) - (k1 - j) * SinCos.sin(k));
                ints2[i1] = j + (int) ((j1 - i) * SinCos.sin(k) + (k1 - j) * SinCos.cos(k));
            }
        }
    }
    ...
    public void s(final Graphics graphics, final int i, final int j, final int k, final int l, final int i1, final int j1, final boolean flag) {
        if (exp != 7) {
            ...
            if (exp == 1) {
                ...
                nx = (int) (Math.random() * n);
                ny = (int) (Math.random() * n);
                nz = (int) (Math.random() * n);
            ...
            if (k1 != n) {
                ...
                rot(ints3, ints2, m.cy, m.cz, m.zy, n);
                boolean flag2 = false;
                final int[] ints4 = new int[n];
                final int[] ints5 = new int[n];
                for (int i2 = 0; i2 < n; ++i2) {
                    ints4[i2] = xs(ints[i2], ints2[i2]);
                    ints5[i2] = ys(ints3[i2], ints2[i2]);
                    if (ints5[i2] > 0 && ints5[i2] < m.h && ints4[i2] > 0 && ints4[i2] < m.w && ints2[i2] > 10 && ints2[i2] < 32) {
                        flag2 = true;
                    }
                }
                if (flag2) {
