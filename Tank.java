...
public class Tank {
   ...
   public void preform(ContO var1, ContO[] var2, int var3, int var4) {
         ...
         if(this.lstage[var8] != 0) {
            ...
            if(this.lhit[var8] == 0) {
               if(this.lstage[var8] > 10 && this.nf[var8] < 15) {
                  ...
                  int var11;
                  int var12;
                  for(var11 = var4; var11 < var4 + 13; ++var11) {
                     var12 = this.getpy(var2[var11].x, var2[var11].y, var2[var11].z, var8);
                  ...
                  if(var9 < 22500 && var9 > 0) {
                     ...
                     short var14 = 0;
                     if(var11 - this.lx[var8] > 0) {
                        var14 = 180;
                     }

                     this.lxz[var8] = (int)((double)(90 + var14) + Math.atan((double)(var12 - this.lz[var8]) / (double)(var11 - this.lx[var8])) / 0.017453292519943295D);
                     short var17 = 0;
                     if(var13 - this.ly[var8] < 0) {
                        var17 = -180;
                     }

                     int var15 = (int)Math.sqrt((double)((var12 - this.lz[var8]) * (var12 - this.lz[var8]) + (var11 - this.lx[var8]) * (var11 - this.lx[var8])));
                     this.lzy[var8] = -((int)((double)(90 + var17) - Math.atan((double)var15 / (double)(var13 - this.ly[var8])) / 0.017453292519943295D));
                     ++this.nf[var8];
                  }
               }
      ...
      if(this.tcnt > this.turnat) {
         ...
         this.gxz = (int)((double)(90 + var16) + Math.atan((double)(var2[var4 + 4].z - var1.z) / (double)(var2[var4 + 4].x - var1.x)) / 0.017453292519943295D);
         ...
         if(var8 < 15000 && var8 > 0 && !var2[var3].exp) {
            ...
            if(this.attack == 1) {
               ...
               this.gxz = (int)((double)(90 + var16) + Math.atan((double)(var2[var3].z - var1.z) / (double)(var2[var3].x - var1.x)) / 0.017453292519943295D);
      ...
      if(this.responce) {
         ...
         for(var9 = var1.xz; var9 >= 360; var9 -= 360) {
            ;
         }
         ...
         if(Math.abs(var9 - this.gxz) > 5) {
            if(var9 > 270 && this.gxz < 90) {
               this.u.left = true;
               this.trgxz = 360 - var9 + this.gxz;
            } else if(var9 < 90 && this.gxz > 270) {
               this.u.right = true;
               this.trgxz = 360 - this.gxz + var9;
            } else if(var9 < this.gxz) {
               this.u.left = true;
               this.trgxz = this.gxz - var9;
            } else {
               this.u.right = true;
               this.trgxz = var9 - this.gxz;
            }
         }
