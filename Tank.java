    ...
    public void preform(final ContO conto, final ContO[] contos, final int i, final int j) {
        ...
        if (u.left) {
            ...
            if ((conto.xy == 0 || conto.xy == 180) && !left) {
                conto.xy = (int) (conto.xy + speed / 5.0F);
                left = true;
            }
        } else if (left) {
            left = false;
                ...
                if (lhit[j1] == 0) {
                    if (lstage[j1] > 10 && nf[j1] < 15) {
                        ...
                        if (k1 < 22500 && k1 > 0) {
                            ...
                            i2 = contos[l2].x;
                            j2 = contos[l2].z;
                            final int k2 = contos[l2].y;
                            short s = 0;
                            if (i2 - lx[j1] > 0) {
                                s = 180;
                            }
                            lxz[j1] = (int) (90 + s + Math.atan((double) (j2 - lz[j1]) / (double) (i2 - lx[j1])) / 0.017453292519943295D);
                            short s2 = 0;
                            if (k2 - ly[j1] < 0) {
                                s2 = -180;
                            }
                            final int l3 = (int) Math.sqrt((j2 - lz[j1]) * (j2 - lz[j1]) + (i2 - lx[j1]) * (i2 - lx[j1]));
        ...
        if (tcnt > turnat) {
            ...
            gxz = (int) (90 + s3 + Math.atan((double) (contos[j + 4].z - conto.z) / (double) (contos[j + 4].x - conto.x)) / 0.017453292519943295D);
            ...
            if (j1 < 15000 && j1 > 0 && !contos[i].exp) {
                ...
                if (attack == 1) {
                    ...
                    gxz = (int) (90 + s3 + Math.atan((double) (contos[i].z - conto.z) / (double) (contos[i].x - conto.x)) / 0.017453292519943295D);
