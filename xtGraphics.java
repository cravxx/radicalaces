	...
	public void denter(Graphics var1, int var2, ContO[] var3, userCraft var4, Control var5) {
		...
		if (this.fase == -5) {
			...
			if (!this.flik) {
				var1.setColor(new Color(225, 230, 255));
				this.flik = true;
				var1.drawLine(250 - this.ws[this.select], 271 + 15 * this.select, 250 + this.ws[this.select],
						271 + 15 * this.select);
				var1.drawRect(250 - this.ws[this.select], 264 + 15 * this.select, this.ws[this.select] * 2, 11);
				var1.setColor(new Color(0, 0, 0));
				var1.drawLine(251 - this.ws[this.select], 271 + 15 * this.select, 255 - this.ws[this.select],
						271 + 15 * this.select);
				var1.drawLine(245 + this.ws[this.select], 271 + 15 * this.select, 249 + this.ws[this.select],
						271 + 15 * this.select);
			} else {
		...
		if (this.fase == -4) {
			if (var5.space) {
				...
				if (!this.frst) {
					...
					this.drawcs(var1, 300, "Mission " + this.level + " completed, do you wish to save game here?", 255,
							255, 255, false);
					if (this.select == 0) {
		...
		if (this.fase == 1) {
			...
			if (var5.space) {
				...
				if (!var5.jade) {
					this.drawcs(var1, 250, "Don\'t forget to press the  [J]  key to escape lasers...", 225, 225, 225,
							false);
				}
	...
	public void dtrakers(Graphics var1, int[] var2, int[] var3, int var4, ContO[] var5, userCraft var6, Control var7) {
		...
		for (var14 = 1; var14 < var4; ++var14) {
			...
			if (var8 > var15 && !var5[var3[var14]].exp) {
				var16 = this.m.cx
						+ (int) ((float) (var5[var3[var14]].x - this.m.x - this.m.cx) * this.m.cs.getcos(this.m.xz)
								- (float) (var5[var3[var14]].z - this.m.z - this.m.cz) * this.m.cs.getsin(this.m.xz));
				var17 = this.m.cz
						+ (int) ((float) (var5[var3[var14]].x - this.m.x - this.m.cx) * this.m.cs.getsin(this.m.xz)
								+ (float) (var5[var3[var14]].z - this.m.z - this.m.cz) * this.m.cs.getcos(this.m.xz));
				var18 = this.m.cz
						+ (int) ((float) (var5[var3[var14]].y - this.m.y - this.m.cy) * this.m.cs.getsin(this.m.zy)
								+ (float) (var17 - this.m.cz) * this.m.cs.getcos(this.m.zy));
				if (var18 > 100) {
					var19 = this.m.cy
							+ (int) ((float) (var5[var3[var14]].y - this.m.y - this.m.cy) * this.m.cs.getcos(this.m.zy)
									- (float) (var17 - this.m.cz) * this.m.cs.getsin(this.m.zy));
		...
		if (this.mcomp && !var5[var3[0]].exp) {
			if (this.rcnt == 0) {
				...
				var1.setColor(new Color(50 + (int) (Math.random() * 200.0D), 50 + (int) (Math.random() * 200.0D),
						50 + (int) (Math.random() * 200.0D)));
		...
		if (!var11 && !var5[var3[this.cl]].exp) {
			boolean var24 = false;
			var25 = this.m.cx
					+ (int) ((float) (var5[var3[this.cl]].x - this.m.x - this.m.cx) * this.m.cs.getcos(this.m.xz)
							- (float) (var5[var3[this.cl]].z - this.m.z - this.m.cz) * this.m.cs.getsin(this.m.xz));
			var16 = this.m.cz
					+ (int) ((float) (var5[var3[this.cl]].x - this.m.x - this.m.cx) * this.m.cs.getsin(this.m.xz)
							+ (float) (var5[var3[this.cl]].z - this.m.z - this.m.cz) * this.m.cs.getcos(this.m.xz));
			var17 = this.m.cz
					+ (int) ((float) (var5[var3[this.cl]].y - this.m.y - this.m.cy) * this.m.cs.getsin(this.m.zy)
							+ (float) (var16 - this.m.cz) * this.m.cs.getcos(this.m.zy));
			var18 = this.m.cy
					+ (int) ((float) (var5[var3[this.cl]].y - this.m.y - this.m.cy) * this.m.cs.getcos(this.m.zy)
							- (float) (var16 - this.m.cz) * this.m.cs.getsin(this.m.zy));
		...
		if (var5[var3[0]].nhits > var5[var3[0]].maxhits - var5[var3[0]].maxhits / 3 && !var5[var3[0]].exp
				&& !this.mcomp) {
			if (this.cnt > 90) {
				if (this.flik) {
		...
		if (var6.ester != 0 && !var5[var3[0]].exp && !this.mcomp) {
			this.drawcs(var1, 300, "Ship Recharged !", 255 * this.m.er, 255 - this.m.eg * 100, 64 + this.m.eb * 191,
					false);
		}
		...
		if (var7.radar && !this.mcomp) {
			...
			for (var16 = 1; var16 < var4; ++var16) {
				if (!var5[var3[var16]].exp) {
					var17 = this.m.cx
							+ (int) ((float) (var5[var3[var16]].x - this.m.x - this.m.cx) * this.m.cs.getcos(var25)
									- (float) (var5[var3[var16]].z - this.m.z - this.m.cz) * this.m.cs.getsin(var25));
					var18 = this.m.cz
							+ (int) ((float) (var5[var3[var16]].x - this.m.x - this.m.cx) * this.m.cs.getsin(var25)
									+ (float) (var5[var3[var16]].z - this.m.z - this.m.cz) * this.m.cs.getcos(var25));
